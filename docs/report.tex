...
Una vez obtenidos los dos embedding correspondientes a la letra de la canci\'on y la m\'usica (MFCC) ya tenemos la entrada de nuestra red neuronal. La misma ser\'a la concatenaci\'on de los dos vectores obtenidos. Luego las siguientes capas ....\todo{arquitectura final}.
